...
if ($name == "") {
    ...
    $to = 'amin.hashemi@mech.sharif.edu';
    ...
    $headers .= 'From:  Amin Hashemi <amin.hashemi@mech.sharif.edu>' . "\r\n";
    $headers .= 'cc: amin.hashemi@mech.sharif.edu' . "\r\n";
    $headers .= 'bcc: amin.hashemi@mech.sharif.edu' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f amin.hashemi@mech.sharif.edu');
